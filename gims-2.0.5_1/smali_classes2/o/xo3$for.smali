.class public final enum Lo/xo3$for;
...
# static fields
.field public static final enum do:Lo/xo3$for;

.field public static final synthetic do:[Lo/xo3$for;

.field public static final enum for:Lo/xo3$for;

.field public static final enum if:Lo/xo3$for;
...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v0, v1, v2, v3, v4}, Lo/xo3$for;-><init>(Ljava/lang/String;ILjava/lang/String;I)V

    sput-object v0, Lo/xo3$for;->do:Lo/xo3$for;
    ...
    invoke-direct {v0, v1, v3, v4, v5}, Lo/xo3$for;-><init>(Ljava/lang/String;ILjava/lang/String;I)V

    sput-object v0, Lo/xo3$for;->if:Lo/xo3$for;
    ...
    invoke-direct {v0, v1, v4, v5, v6}, Lo/xo3$for;-><init>(Ljava/lang/String;ILjava/lang/String;I)V

    sput-object v0, Lo/xo3$for;->for:Lo/xo3$for;

    const/4 v1, 0x3

    new-array v1, v1, [Lo/xo3$for;

    sget-object v5, Lo/xo3$for;->do:Lo/xo3$for;

    aput-object v5, v1, v2

    sget-object v2, Lo/xo3$for;->if:Lo/xo3$for;

    aput-object v2, v1, v3

    aput-object v0, v1, v4

    sput-object v1, Lo/xo3$for;->do:[Lo/xo3$for;
...
.method public constructor <init>(Ljava/lang/String;ILjava/lang/String;I)V
    ...
    invoke-static {p0, p3, p4}, Lo/xo3;->do(Lo/xo3$for;Ljava/lang/String;I)V

    return-void
.end method

.method public static synthetic class(Lo/xo3$for;)[I
    .locals 0

    iget-object p0, p0, Lo/xo3$for;->if:[I

    return-object p0
.end method

.method public static synthetic do(Lo/xo3$for;)[Ljava/lang/String;
    .locals 0

    iget-object p0, p0, Lo/xo3$for;->if:[Ljava/lang/String;

    return-object p0
.end method

.method public static synthetic else(Lo/xo3$for;[I)[I
    .locals 0

    iput-object p1, p0, Lo/xo3$for;->do:[I

    return-object p1
.end method

.method public static synthetic final(Lo/xo3$for;[I)[I
    .locals 0

    iput-object p1, p0, Lo/xo3$for;->if:[I

    return-object p1
.end method

.method public static synthetic for(Lo/xo3$for;)[I
    .locals 0

    iget-object p0, p0, Lo/xo3$for;->do:[I

    return-object p0
.end method

.method public static synthetic if(Lo/xo3$for;[Ljava/lang/String;)[Ljava/lang/String;
    .locals 0

    iput-object p1, p0, Lo/xo3$for;->if:[Ljava/lang/String;

    return-object p1
.end method

.method public static synthetic throw(Lo/xo3$for;)[Ljava/lang/String;
    .locals 0

    iget-object p0, p0, Lo/xo3$for;->for:[Ljava/lang/String;

    return-object p0
.end method

.method public static valueOf(Ljava/lang/String;)Lo/xo3$for;
    .locals 1

    const-class v0, Lo/xo3$for;

    invoke-static {v0, p0}, Ljava/lang/Enum;->valueOf(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Enum;

    move-result-object p0

    check-cast p0, Lo/xo3$for;

    return-object p0
.end method

.method public static values()[Lo/xo3$for;
    .locals 1

    sget-object v0, Lo/xo3$for;->do:[Lo/xo3$for;

    invoke-virtual {v0}, [Lo/xo3$for;->clone()Ljava/lang/Object;

    move-result-object v0

    check-cast v0, [Lo/xo3$for;

    return-object v0
.end method

.method public static synthetic while(Lo/xo3$for;[Ljava/lang/String;)[Ljava/lang/String;
    .locals 0

    iput-object p1, p0, Lo/xo3$for;->for:[Ljava/lang/String;
...
.method public import(Ljava/lang/String;)I
    ...
    iget-object v0, p0, Lo/xo3$for;->if:[Ljava/lang/String;
    ...
    iget-object v0, p0, Lo/xo3$for;->do:[I
...
.method public native(I)Ljava/lang/String;
    .locals 4

    iget-object v0, p0, Lo/xo3$for;->if:[I
    ...
    iget-object v1, p0, Lo/xo3$for;->for:[Ljava/lang/String;
    ...
    iget-object v2, p0, Lo/xo3$for;->if:[I
    ...
    :cond_0
    iget-object p1, p0, Lo/xo3$for;->for:[Ljava/lang/String;
