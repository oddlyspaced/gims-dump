...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lo/mk0;->do:Ljava/util/regex/Pattern;

    return-void
.end method

.method public static case(Landroid/util/SparseArray;I)Lo/mk0$new;
    .locals 1
    ...
    check-cast v0, Lo/mk0$new;

    if-nez v0, :cond_0

    new-instance v0, Lo/mk0$new;

    invoke-direct {v0}, Lo/mk0$new;-><init>()V
...
.method public static do(Ljava/lang/CharSequence;F)Lo/mk0$if;
    .locals 8
    ...
    invoke-direct {p0, v1, p1, v0}, Lo/mk0$if;-><init>(Ljava/lang/String;Ljava/util/Map;Lo/mk0$do;)V
    ...
    new-instance p1, Lo/mk0$if;

    invoke-static {p0}, Lo/mk0;->if(Ljava/lang/CharSequence;)Ljava/lang/String;
    ...
    invoke-direct {p1, p0, v1, v0}, Lo/mk0$if;-><init>(Ljava/lang/String;Ljava/util/Map;Lo/mk0$do;)V
    ...
    invoke-static {v5}, Lo/dk0;->do(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v3}, Lo/dk0;->if(I)Ljava/lang/String;
    ...
    invoke-static {v3, v6}, Lo/on0;->extends(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    ...
    :cond_3
    invoke-static {p0, p1}, Lo/mk0;->for(Landroid/text/Spanned;F)Landroid/util/SparseArray;
    ...
    invoke-static {v3}, Lo/mk0;->if(Ljava/lang/CharSequence;)Ljava/lang/String;
    ...
    check-cast v3, Lo/mk0$new;

    invoke-static {v3}, Lo/mk0$new;->do(Lo/mk0$new;)Ljava/util/List;

    move-result-object v6

    invoke-static {}, Lo/mk0$for;->do()Ljava/util/Comparator;
    ...
    check-cast v7, Lo/mk0$for;

    iget-object v7, v7, Lo/mk0$for;->if:Ljava/lang/String;
    ...
    :cond_4
    invoke-static {v3}, Lo/mk0$new;->if(Lo/mk0$new;)Ljava/util/List;

    move-result-object v6

    invoke-static {}, Lo/mk0$for;->if()Ljava/util/Comparator;
    ...
    check-cast v6, Lo/mk0$for;

    iget-object v6, v6, Lo/mk0$for;->do:Ljava/lang/String;
    ...
    invoke-direct {p0, p1, v2, v0}, Lo/mk0$if;-><init>(Ljava/lang/String;Ljava/util/Map;Lo/mk0$do;)V

    return-object p0
.end method

.method public static for(Landroid/text/Spanned;F)Landroid/util/SparseArray;
    .locals 13
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v4, p1}, Lo/mk0;->try(Ljava/lang/Object;F)Ljava/lang/String;

    move-result-object v8

    invoke-static {v4}, Lo/mk0;->new(Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-direct/range {v5 .. v10}, Lo/mk0$for;-><init>(IILjava/lang/String;Ljava/lang/String;Lo/mk0$do;)V

    invoke-static {v0, v11}, Lo/mk0;->case(Landroid/util/SparseArray;I)Lo/mk0$new;

    move-result-object v5

    invoke-static {v5}, Lo/mk0$new;->if(Lo/mk0$new;)Ljava/util/List;

    move-result-object v5

    invoke-interface {v5, v12}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    invoke-static {v0, v4}, Lo/mk0;->case(Landroid/util/SparseArray;I)Lo/mk0$new;

    move-result-object v4

    invoke-static {v4}, Lo/mk0$new;->do(Lo/mk0$new;)Ljava/util/List;
...
.method public static if(Ljava/lang/CharSequence;)Ljava/lang/String;
    .locals 1
    ...
    sget-object v0, Lo/mk0;->do:Ljava/util/regex/Pattern;
...
.method public static new(Ljava/lang/Object;)Ljava/lang/String;
    ...
    :cond_6
    instance-of v0, p0, Lo/gi0;

    if-eqz v0, :cond_7

    check-cast p0, Lo/gi0;

    iget-object p0, p0, Lo/gi0;->do:Ljava/lang/String;
...
.method public static try(Ljava/lang/Object;F)Ljava/lang/String;
    .locals 3
    ...
    :cond_c
    instance-of p1, p0, Lo/gi0;

    if-eqz p1, :cond_10

    check-cast p0, Lo/gi0;

    iget p0, p0, Lo/gi0;->do:I
