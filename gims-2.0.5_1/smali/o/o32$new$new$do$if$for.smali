.class public abstract Lo/o32$new$new$do$if$for;
...
.method public static do()Lo/o32$new$new$do$if$for$do;
    .locals 1

    new-instance v0, Lo/g32$if;

    invoke-direct {v0}, Lo/g32$if;-><init>()V
...
.method public abstract if()Lo/o32$new$new$do$if$for;
.end method
