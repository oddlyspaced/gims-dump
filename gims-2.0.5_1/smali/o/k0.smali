...
.method public constructor <init>(Landroid/widget/ImageView;)V
    ...
    iput-object p1, p0, Lo/k0;->do:Landroid/widget/ImageView;
...
.method public final break()Z
    ...
    iget-object v0, p0, Lo/k0;->do:Lo/q1;
...
.method public case(Landroid/util/AttributeSet;I)V
    .locals 8

    iget-object v0, p0, Lo/k0;->do:Landroid/widget/ImageView;

    invoke-virtual {v0}, Landroid/widget/ImageView;->getContext()Landroid/content/Context;

    move-result-object v0

    sget-object v1, Lo/super;->AppCompatImageView:[I
    ...
    iget-object v1, p0, Lo/k0;->do:Landroid/widget/ImageView;

    invoke-virtual {v1}, Landroid/widget/ImageView;->getContext()Landroid/content/Context;

    move-result-object v2

    sget-object v3, Lo/super;->AppCompatImageView:[I
    ...
    :try_start_0
    iget-object p1, p0, Lo/k0;->do:Landroid/widget/ImageView;
    ...
    sget v1, Lo/super;->AppCompatImageView_srcCompat:I

    invoke-virtual {v0, v1, p2}, Lo/s1;->final(II)I
    ...
    invoke-static {p1, v1}, Lo/private;->new(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {p1}, Lo/z0;->if(Landroid/graphics/drawable/Drawable;)V

    :cond_1
    sget p1, Lo/super;->AppCompatImageView_tint:I
    ...
    sget v1, Lo/super;->AppCompatImageView_tint:I

    invoke-virtual {v0, v1}, Lo/s1;->for(I)Landroid/content/res/ColorStateList;

    move-result-object v1

    invoke-static {p1, v1}, Lo/i9;->for(Landroid/widget/ImageView;Landroid/content/res/ColorStateList;)V

    :cond_2
    sget p1, Lo/super;->AppCompatImageView_tintMode:I
    ...
    sget v1, Lo/super;->AppCompatImageView_tintMode:I
    ...
    invoke-static {p1, p2}, Lo/i9;->new(Landroid/widget/ImageView;Landroid/graphics/PorterDuff$Mode;)V
    :try_end_0
...
.method public final do(Landroid/graphics/drawable/Drawable;)Z
    ...
    iget-object v0, p0, Lo/k0;->for:Lo/q1;
    ...
    iput-object v0, p0, Lo/k0;->for:Lo/q1;
    ...
    invoke-static {v1}, Lo/i9;->do(Landroid/widget/ImageView;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {v1}, Lo/i9;->if(Landroid/widget/ImageView;)Landroid/graphics/PorterDuff$Mode;
...
.method public for()Landroid/content/res/ColorStateList;
    ...
    iget-object v0, p0, Lo/k0;->if:Lo/q1;
...
.method public goto(Landroid/content/res/ColorStateList;)V
    ...
    iput-object v0, p0, Lo/k0;->if:Lo/q1;
...
.method public if()V
    ...
    invoke-virtual {p0}, Lo/k0;->break()Z

    move-result v1

    if-eqz v1, :cond_1

    invoke-virtual {p0, v0}, Lo/k0;->do(Landroid/graphics/drawable/Drawable;)Z
    ...
    :cond_1
    iget-object v1, p0, Lo/k0;->if:Lo/q1;

    if-eqz v1, :cond_2

    iget-object v2, p0, Lo/k0;->do:Landroid/widget/ImageView;
    ...
    :cond_2
    iget-object v1, p0, Lo/k0;->do:Lo/q1;
...
.method public this(Landroid/graphics/PorterDuff$Mode;)V
    .locals 1
