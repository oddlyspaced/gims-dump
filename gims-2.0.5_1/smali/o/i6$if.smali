...
.method public constructor <init>(C[F)V
    ...
    iput-char p1, p0, Lo/i6$if;->do:C

    iput-object p2, p0, Lo/i6$if;->do:[F

    return-void
.end method

.method public constructor <init>(Lo/i6$if;)V
    .locals 2

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iget-char v0, p1, Lo/i6$if;->do:C

    iput-char v0, p0, Lo/i6$if;->do:C

    iget-object p1, p1, Lo/i6$if;->do:[F

    array-length v0, p1

    const/4 v1, 0x0

    invoke-static {p1, v1, v0}, Lo/i6;->for([FII)[F

    move-result-object p1

    iput-object p1, p0, Lo/i6$if;->do:[F

    return-void
.end method

.method public static do(Landroid/graphics/Path;[FCC[F)V
    .locals 25
    ...
    invoke-static/range {v0 .. v9}, Lo/i6$if;->for(Landroid/graphics/Path;FFFFFFFZZ)V
...
.method public static for(Landroid/graphics/Path;FFFFFFFZZ)V
    .locals 41
    ...
    invoke-static/range {v6 .. v24}, Lo/i6$if;->if(Landroid/graphics/Path;DDDDDDDDD)V

    return-void
.end method

.method public static if(Landroid/graphics/Path;DDDDDDDDD)V
    .locals 49
...
.method public static try([Lo/i6$if;Landroid/graphics/Path;)V
    .locals 5
    ...
    invoke-static {p1, v0, v1, v3, v4}, Lo/i6$if;->do(Landroid/graphics/Path;[FCC[F)V

    aget-object v1, p0, v2

    iget-char v1, v1, Lo/i6$if;->do:C
...
# virtual methods
.method public new(Lo/i6$if;Lo/i6$if;F)V
    .locals 4
    ...
    :goto_0
    iget-object v1, p1, Lo/i6$if;->do:[F

    array-length v2, v1

    if-ge v0, v2, :cond_0

    iget-object v2, p0, Lo/i6$if;->do:[F
    ...
    iget-object v3, p2, Lo/i6$if;->do:[F
