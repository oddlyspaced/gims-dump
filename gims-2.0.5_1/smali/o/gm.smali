...
# virtual methods
.method public final do(Lo/wl;Ljava/util/Map;)Lorg/apache/http/HttpResponse;
    .locals 5
    ...
    invoke-virtual {p0, p1, p2}, Lo/gm;->if(Lo/wl;Ljava/util/Map;)Lo/mm;
    ...
    invoke-virtual {p1}, Lo/mm;->for()Ljava/util/List;
    ...
    invoke-virtual {v2}, Lo/pl;->if()Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lo/mm;->do()Ljava/io/InputStream;
...
.method public abstract if(Lo/wl;Ljava/util/Map;)Lo/mm;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lo/wl<",
