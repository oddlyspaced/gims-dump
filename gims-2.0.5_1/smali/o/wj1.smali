...
.method public constructor <init>(Lo/el1;)V
    ...
    invoke-direct {p1, p0, v0, v1}, Lo/vj1;-><init>(Lo/wj1;Landroid/content/Context;Ljava/lang/String;)V

    iput-object p1, p0, Lo/wj1;->do:Lo/vj1;

    return-void
.end method

.method public static package(Landroid/database/sqlite/SQLiteDatabase;)J
    .locals 10
...
# virtual methods
.method public final abstract(I[B)Z
    .locals 16
    ...
    iget-boolean v0, v1, Lo/wj1;->if:Z
    ...
    :try_start_0
    invoke-virtual/range {p0 .. p0}, Lo/wj1;->implements()Landroid/database/sqlite/SQLiteDatabase;
    ...
    :try_start_1
    iput-boolean v8, v1, Lo/wj1;->if:Z
    :try_end_1
    ...
    invoke-virtual {v15}, Lo/ak1;->continue()Lo/ck1;

    move-result-object v15

    const-string v4, "Data loss, local db full"

    invoke-virtual {v15, v4}, Lo/ck1;->do(Ljava/lang/String;)V
    ...
    invoke-virtual {v4, v15, v2, v8, v10}, Lo/ck1;->new(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-virtual {v2, v4, v0}, Lo/ck1;->if(Ljava/lang/String;Ljava/lang/Object;)V

    const/4 v2, 0x1

    iput-boolean v2, v1, Lo/wj1;->if:Z
    :try_end_5
...
.method public final continue(Lcom/google/android/gms/measurement/internal/zzar;)Z
    .locals 3
    ...
    :cond_0
    invoke-virtual {p0, v1, p1}, Lo/wj1;->abstract(I[B)Z
...
.method public final implements()Landroid/database/sqlite/SQLiteDatabase;
    .locals 2

    iget-boolean v0, p0, Lo/wj1;->if:Z
    ...
    :cond_0
    iget-object v0, p0, Lo/wj1;->do:Lo/vj1;

    invoke-virtual {v0}, Lo/vj1;->getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    ...
    iput-boolean v0, p0, Lo/wj1;->if:Z
...
.method public final interface()V
    ...
    :try_start_0
    invoke-virtual {p0}, Lo/wj1;->implements()Landroid/database/sqlite/SQLiteDatabase;
...
.method public final private(I)Ljava/util/List;
    .locals 21
    ...
    invoke-virtual/range {p0 .. p0}, Lo/wj1;->instanceof()Z
    ...
    :try_start_1
    iput-boolean v9, v1, Lo/wj1;->if:Z
    :try_end_1
    ...
    invoke-static {v15}, Lo/wj1;->package(Landroid/database/sqlite/SQLiteDatabase;)J
    ...
    :try_end_7
    .catch Lo/ys0$do; {:try_start_7 .. :try_end_7} :catch_2
    ...
    invoke-virtual {v0, v12}, Lo/ck1;->do(Ljava/lang/String;)V
    :try_end_9
    ...
    :try_end_b
    .catch Lo/ys0$do; {:try_start_b .. :try_end_b} :catch_3
    ...
    :try_end_f
    .catch Lo/ys0$do; {:try_start_f .. :try_end_f} :catch_4
    ...
    :goto_9
    invoke-virtual {v0, v11}, Lo/ck1;->do(Ljava/lang/String;)V
    ...
    invoke-virtual {v5, v2, v0}, Lo/ck1;->if(Ljava/lang/String;Ljava/lang/Object;)V
...
.method public final protected()Z
    ...
    invoke-virtual {p0, v1, v0}, Lo/wj1;->abstract(I[B)Z
...
.method public final strictfp(Lcom/google/android/gms/measurement/internal/zzkr;)Z
    .locals 3
    ...
    invoke-virtual {p0, v0, p1}, Lo/wj1;->abstract(I[B)Z
...
.method public final transient()Z
    ...
    iget-boolean v1, p0, Lo/wj1;->if:Z
    ...
    :cond_0
    invoke-virtual {p0}, Lo/wj1;->instanceof()Z
    ...
    iput-boolean v6, p0, Lo/wj1;->if:Z
    :try_end_0
    ...
    invoke-virtual {v8, v0, v7}, Lo/ck1;->if(Ljava/lang/String;Ljava/lang/Object;)V
...
.method public final volatile(Lcom/google/android/gms/measurement/internal/zzw;)Z
    .locals 2

    invoke-virtual {p0}, Lo/yl1;->catch()Lo/hq1;

    invoke-static {p1}, Lo/hq1;->rPSHcdNANq(Landroid/os/Parcelable;)[B
