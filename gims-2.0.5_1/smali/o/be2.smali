...
.method public static break(Landroid/hardware/Camera$Parameters;)V
    .locals 3
    ...
    invoke-static {v0}, Lo/be2;->do(I)Ljava/util/List;
    ...
    invoke-static {v0}, Lo/be2;->const(Ljava/lang/Iterable;)Ljava/lang/String;
...
.method public static case(Landroid/hardware/Camera$Parameters;II)V
    .locals 8
    ...
    invoke-static {v0}, Lo/be2;->final(Ljava/util/Collection;)Ljava/lang/String;
...
.method public static catch(Landroid/hardware/Camera$Parameters;Z)V
    .locals 3
    ...
    invoke-static {v1, v0, p1}, Lo/be2;->if(Ljava/lang/String;Ljava/util/Collection;[Ljava/lang/String;)Ljava/lang/String;
...
.method public static class(Landroid/hardware/Camera$Parameters;)V
    .locals 1
    .annotation build Landroid/annotation/TargetApi;
        value = 0xf
    .end annotation
...
.method public static const(Ljava/lang/Iterable;)Ljava/lang/String;
    .locals 3
    .annotation build Landroid/annotation/TargetApi;
        value = 0xf
    .end annotation
...
.method public static do(I)Ljava/util/List;
    .locals 3
    .annotation build Landroid/annotation/TargetApi;
        value = 0xf
    .end annotation
...
.method public static else(Landroid/hardware/Camera$Parameters;Lo/pj2$do;Z)V
    .locals 5
    ...
    sget-object v4, Lo/pj2$do;->do:Lo/pj2$do;
    ...
    :cond_0
    sget-object v4, Lo/pj2$do;->if:Lo/pj2$do;
    ...
    invoke-static {v3, v0, p1}, Lo/be2;->if(Ljava/lang/String;Ljava/util/Collection;[Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_1
    sget-object v2, Lo/pj2$do;->for:Lo/pj2$do;
    ...
    :cond_2
    sget-object v2, Lo/pj2$do;->new:Lo/pj2$do;
...
.method public static final(Ljava/util/Collection;)Ljava/lang/String;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static for(Landroid/hardware/Camera$Parameters;)V
    .locals 3
    ...
    invoke-static {v2, v0, v1}, Lo/be2;->if(Ljava/lang/String;Ljava/util/Collection;[Ljava/lang/String;)Ljava/lang/String;
...
.method public static goto(Landroid/hardware/Camera$Parameters;)V
    .locals 3
    .annotation build Landroid/annotation/TargetApi;
        value = 0xf
    .end annotation
    ...
    invoke-static {v1}, Lo/be2;->const(Ljava/lang/Iterable;)Ljava/lang/String;
...
.method public static varargs if(Ljava/lang/String;Ljava/util/Collection;[Ljava/lang/String;)Ljava/lang/String;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static new(Landroid/hardware/Camera$Parameters;Z)V
    .locals 5
...
.method public static this(Landroid/hardware/Camera$Parameters;)V
    .locals 3
...
.method public static try(Landroid/hardware/Camera$Parameters;)V
    .locals 2
    ...
    invoke-static {p0, v0, v1}, Lo/be2;->case(Landroid/hardware/Camera$Parameters;II)V
