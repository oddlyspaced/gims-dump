...
# direct methods
.method public constructor <init>(Lo/nk1;Ljava/lang/String;Landroid/os/Bundle;)V
    .locals 0

    iput-object p1, p0, Lo/ok1;->do:Lo/nk1;

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    invoke-static {p2}, Lo/vs0;->case(Ljava/lang/String;)Ljava/lang/String;

    iput-object p2, p0, Lo/ok1;->do:Ljava/lang/String;

    new-instance p1, Landroid/os/Bundle;

    invoke-direct {p1}, Landroid/os/Bundle;-><init>()V

    iput-object p1, p0, Lo/ok1;->do:Landroid/os/Bundle;
...
# virtual methods
.method public final do()Landroid/os/Bundle;
    .locals 12

    iget-boolean v0, p0, Lo/ok1;->do:Z

    if-nez v0, :cond_9

    const/4 v0, 0x1

    iput-boolean v0, p0, Lo/ok1;->do:Z

    iget-object v1, p0, Lo/ok1;->do:Lo/nk1;

    invoke-virtual {v1}, Lo/nk1;->abstract()Landroid/content/SharedPreferences;

    move-result-object v1

    iget-object v2, p0, Lo/ok1;->do:Ljava/lang/String;
    ...
    :try_start_2
    iget-object v5, p0, Lo/ok1;->do:Lo/nk1;
    ...
    invoke-virtual {v5, v6}, Lo/ck1;->do(Ljava/lang/String;)V
    ...
    :cond_7
    iput-object v2, p0, Lo/ok1;->if:Landroid/os/Bundle;
    :try_end_3
    ...
    :catch_1
    iget-object v0, p0, Lo/ok1;->do:Lo/nk1;
    ...
    :cond_8
    :goto_3
    iget-object v0, p0, Lo/ok1;->if:Landroid/os/Bundle;

    if-nez v0, :cond_9

    iget-object v0, p0, Lo/ok1;->do:Landroid/os/Bundle;

    iput-object v0, p0, Lo/ok1;->if:Landroid/os/Bundle;
...
.method public final for(Landroid/os/Bundle;)Ljava/lang/String;
    .locals 6
    ...
    :cond_3
    iget-object v2, p0, Lo/ok1;->do:Lo/nk1;
    ...
    iget-object v3, p0, Lo/ok1;->do:Lo/nk1;
...
.method public final if(Landroid/os/Bundle;)V
    ...
    iget-object v1, p0, Lo/ok1;->do:Ljava/lang/String;
    ...
    invoke-virtual {p0, p1}, Lo/ok1;->for(Landroid/os/Bundle;)Ljava/lang/String;
    ...
    iput-object p1, p0, Lo/ok1;->if:Landroid/os/Bundle;
