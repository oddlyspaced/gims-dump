...
# instance fields
.field public final do:Lorg/apache/http/client/HttpClient;
...
.method public constructor <init>(Lorg/apache/http/client/HttpClient;)V
    ...
    iput-object p1, p0, Lo/km;->do:Lorg/apache/http/client/HttpClient;

    return-void
.end method

.method public static if(Lo/wl;Ljava/util/Map;)Lorg/apache/http/client/methods/HttpUriRequest;
    .locals 3
    ...
    :pswitch_0
    new-instance p1, Lo/km$do;

    invoke-virtual {p0}, Lo/wl;->r8V2qFtK0b()Ljava/lang/String;

    move-result-object v1

    invoke-direct {p1, v1}, Lo/km$do;-><init>(Ljava/lang/String;)V
    ...
    invoke-static {p1, p0}, Lo/km;->new(Lorg/apache/http/client/methods/HttpEntityEnclosingRequestBase;Lo/wl;)V
    ...
    :pswitch_8
    invoke-virtual {p0}, Lo/wl;->implements()[B
    ...
    invoke-virtual {p0}, Lo/wl;->instanceof()Ljava/lang/String;
...
.method public static new(Lorg/apache/http/client/methods/HttpEntityEnclosingRequestBase;Lo/wl;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static try(Lorg/apache/http/client/methods/HttpUriRequest;Ljava/util/Map;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
# virtual methods
.method public do(Lo/wl;Ljava/util/Map;)Lorg/apache/http/HttpResponse;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p1, p2}, Lo/km;->if(Lo/wl;Ljava/util/Map;)Lorg/apache/http/client/methods/HttpUriRequest;

    move-result-object v0

    invoke-static {v0, p2}, Lo/km;->try(Lorg/apache/http/client/methods/HttpUriRequest;Ljava/util/Map;)V
    ...
    invoke-virtual {p0, v0}, Lo/km;->for(Lorg/apache/http/client/methods/HttpUriRequest;)V
    ...
    iget-object p1, p0, Lo/km;->do:Lorg/apache/http/client/HttpClient;
...
.method public for(Lorg/apache/http/client/methods/HttpUriRequest;)V
    .locals 0
