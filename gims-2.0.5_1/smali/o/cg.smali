...
# static fields
.field public static do:Landroid/animation/LayoutTransition;
...
# direct methods
.method public static do(Landroid/animation/LayoutTransition;)V
    .locals 5

    sget-boolean v0, Lo/cg;->if:Z
    ...
    sput-object v2, Lo/cg;->do:Ljava/lang/reflect/Method;
    ...
    :catch_0
    sput-boolean v0, Lo/cg;->if:Z

    :cond_0
    sget-object v0, Lo/cg;->do:Ljava/lang/reflect/Method;
...
.method public static if(Landroid/view/ViewGroup;Z)V
    ...
    sget-object v0, Lo/cg;->do:Landroid/animation/LayoutTransition;
    ...
    new-instance v0, Lo/cg$do;

    invoke-direct {v0}, Lo/cg$do;-><init>()V

    sput-object v0, Lo/cg;->do:Landroid/animation/LayoutTransition;
    ...
    invoke-static {p1}, Lo/cg;->do(Landroid/animation/LayoutTransition;)V
    ...
    sget v0, Lo/nf;->transition_layout_save:I

    invoke-virtual {p0, v0, p1}, Landroid/view/ViewGroup;->setTag(ILjava/lang/Object;)V

    :cond_2
    sget-object p1, Lo/cg;->do:Landroid/animation/LayoutTransition;
    ...
    sput-object p1, Lo/cg;->do:Ljava/lang/reflect/Field;
    ...
    :catch_0
    sput-boolean v1, Lo/cg;->do:Z

    :cond_4
    sget-object p1, Lo/cg;->do:Ljava/lang/reflect/Field;
    ...
    :try_start_2
    sget-object v0, Lo/cg;->do:Ljava/lang/reflect/Field;
    ...
    :cond_7
    sget p1, Lo/nf;->transition_layout_save:I
