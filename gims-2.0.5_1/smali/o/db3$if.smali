...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lo/db3;->LxXpisMEus(Lo/nb3;Lo/pa3;)V
.end annotation
...
# instance fields
.field public final synthetic do:Lo/db3;
...
# direct methods
.method public constructor <init>(Lo/db3;Lo/nb3;Lo/pa3;Lo/ta3;)V
    .locals 0

    iput-object p1, p0, Lo/db3$if;->do:Lo/db3;

    iput-object p2, p0, Lo/db3$if;->do:Lo/nb3;

    iput-object p3, p0, Lo/db3$if;->do:Lo/pa3;

    iput-object p4, p0, Lo/db3$if;->do:Lo/ta3;
...
.method public onClick(Landroid/view/View;)V
    ...
    :try_start_0
    iget-object v0, p0, Lo/db3$if;->do:Lo/nb3;
    ...
    iget-object p1, p0, Lo/db3$if;->do:Lo/db3;

    invoke-virtual {p1}, Lo/db3;->kNtBQIfJET()Landroid/widget/ProgressBar;
    ...
    invoke-virtual {p1}, Lo/db3;->iq0aIYvzK9()Landroid/widget/TextView;
    ...
    iget-object v1, p0, Lo/db3$if;->do:Lo/pa3;
    ...
    iget-object v1, p0, Lo/db3$if;->do:Lo/ta3;
