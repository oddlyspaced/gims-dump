...
.method public constructor <init>()V
    ...
    invoke-direct {p0, v0}, Lo/zc0;-><init>(Ljava/lang/String;)V
...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lo/zc0;->do:Lo/cn0;
    ...
    iput-object v1, p0, Lo/zc0;->do:Lo/dn0;

    const/4 v0, 0x0

    iput v0, p0, Lo/zc0;->do:I

    iput-object p1, p0, Lo/zc0;->do:Ljava/lang/String;
...
.method public final do(Lo/dn0;[BI)Z
    ...
    iget p1, p0, Lo/zc0;->if:I

    add-int/2addr p1, v0

    iput p1, p0, Lo/zc0;->if:I
...
.method public final else()V
    ...
    iget-object v0, p0, Lo/zc0;->do:Lo/cn0;
    ...
    invoke-static {v0}, Lo/v60;->try(Lo/cn0;)Lo/v60$if;

    move-result-object v0

    iget-object v1, p0, Lo/zc0;->do:Lcom/google/android/exoplayer2/Format;

    if-eqz v1, :cond_0

    iget v2, v0, Lo/v60$if;->if:I

    iget v3, v1, Lcom/google/android/exoplayer2/Format;->catch:I

    if-ne v2, v3, :cond_0

    iget v2, v0, Lo/v60$if;->do:I

    iget v3, v1, Lcom/google/android/exoplayer2/Format;->class:I

    if-ne v2, v3, :cond_0

    iget-object v2, v0, Lo/v60$if;->do:Ljava/lang/String;

    iget-object v1, v1, Lcom/google/android/exoplayer2/Format;->case:Ljava/lang/String;

    invoke-static {v2, v1}, Lo/on0;->if(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    iget-object v2, p0, Lo/zc0;->if:Ljava/lang/String;

    invoke-virtual {v1, v2}, Lcom/google/android/exoplayer2/Format$if;->JhwFA7sgYj(Ljava/lang/String;)Lcom/google/android/exoplayer2/Format$if;
    ...
    iget-object v2, p0, Lo/zc0;->do:Ljava/lang/String;
    ...
    iput-object v1, p0, Lo/zc0;->do:Lcom/google/android/exoplayer2/Format;

    iget-object v2, p0, Lo/zc0;->do:Lo/na0;

    invoke-interface {v2, v1}, Lo/na0;->do(Lcom/google/android/exoplayer2/Format;)V

    :cond_1
    iget v1, v0, Lo/v60$if;->for:I

    iput v1, p0, Lo/zc0;->for:I

    const-wide/32 v1, 0xf4240

    iget v0, v0, Lo/v60$if;->new:I

    int-to-long v3, v0

    mul-long v3, v3, v1

    iget-object v0, p0, Lo/zc0;->do:Lcom/google/android/exoplayer2/Format;
...
.method public for()V
    ...
    iput v0, p0, Lo/zc0;->if:I

    iput-boolean v0, p0, Lo/zc0;->do:Z
...
.method public final goto(Lo/dn0;)Z
    ...
    iget-boolean v0, p0, Lo/zc0;->do:Z
    ...
    :cond_0
    iput-boolean v1, p0, Lo/zc0;->do:Z
...
.method public if(Lo/dn0;)V
    ...
    iget-object v0, p0, Lo/zc0;->do:Lo/na0;
    ...
    iget v2, p0, Lo/zc0;->for:I

    iget v3, p0, Lo/zc0;->if:I
    ...
    iget v2, p0, Lo/zc0;->if:I

    add-int/2addr v2, v0

    iput v2, p0, Lo/zc0;->if:I

    iget v7, p0, Lo/zc0;->for:I

    if-ne v2, v7, :cond_0

    iget-object v3, p0, Lo/zc0;->do:Lo/na0;

    iget-wide v4, p0, Lo/zc0;->if:J
    ...
    iget-wide v2, p0, Lo/zc0;->if:J

    iget-wide v4, p0, Lo/zc0;->do:J

    add-long/2addr v2, v4

    iput-wide v2, p0, Lo/zc0;->if:J

    iput v1, p0, Lo/zc0;->do:I

    goto :goto_0

    :cond_2
    iget-object v0, p0, Lo/zc0;->do:Lo/dn0;
    ...
    invoke-virtual {p0, p1, v0, v3}, Lo/zc0;->do(Lo/dn0;[BI)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Lo/zc0;->else()V
    ...
    iget-object v1, p0, Lo/zc0;->do:Lo/dn0;

    invoke-interface {v0, v1, v3}, Lo/na0;->for(Lo/dn0;I)V

    iput v2, p0, Lo/zc0;->do:I

    goto :goto_0

    :cond_3
    invoke-virtual {p0, p1}, Lo/zc0;->goto(Lo/dn0;)Z

    move-result v0

    if-eqz v0, :cond_0

    iput v3, p0, Lo/zc0;->do:I
...
.method public new(Lo/z90;Lo/be0$new;)V
    ...
    iput-object v0, p0, Lo/zc0;->if:Ljava/lang/String;
    ...
    iput-object p1, p0, Lo/zc0;->do:Lo/na0;
