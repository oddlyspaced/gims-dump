...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lo/eb3;->LxXpisMEus(Lo/nb3;Lo/pa3;)V
.end annotation
...
# instance fields
.field public final synthetic do:Lo/eb3;
...
# direct methods
.method public constructor <init>(Lo/eb3;Lo/pa3;Lo/ta3;Lo/nb3;)V
    .locals 0

    iput-object p1, p0, Lo/eb3$if;->do:Lo/eb3;

    iput-object p2, p0, Lo/eb3$if;->do:Lo/pa3;

    iput-object p3, p0, Lo/eb3$if;->do:Lo/ta3;

    iput-object p4, p0, Lo/eb3$if;->do:Lo/nb3;
...
.method public onClick(Landroid/view/View;)V
    ...
    :try_start_0
    iget-object v0, p0, Lo/eb3$if;->do:Lo/pa3;
    ...
    iget-object p1, p0, Lo/eb3$if;->do:Lo/eb3;

    invoke-virtual {p1}, Lo/eb3;->kNtBQIfJET()Landroid/widget/ProgressBar;
    ...
    invoke-virtual {p1}, Lo/eb3;->iq0aIYvzK9()Landroid/widget/TextView;
    ...
    iget-object v3, p0, Lo/eb3$if;->do:Lo/pa3;
    ...
    iget-object v3, p0, Lo/eb3$if;->do:Lo/ta3;
    ...
    :cond_8
    iget-object v0, p0, Lo/eb3$if;->do:Lo/ta3;
    ...
    iget-object v3, p0, Lo/eb3$if;->do:Lo/nb3;

    invoke-virtual {v3}, Lo/nb3;->protected()Landroid/content/Context;
    ...
    iget-object v4, p0, Lo/eb3$if;->do:Lo/nb3;
