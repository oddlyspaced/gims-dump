...
.field public mRemoteUserInfo:Lo/oc;
...
.field public mVolumeCallback:Lo/sc$do;

.field public mVolumeProvider:Lo/sc;
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/app/PendingIntent;)V
    ...
    iput-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeCallback:Lo/sc$do;
...
.method public adjustVolume(II)V
    ...
    iget-object p2, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:Lo/sc;

    if-eqz p2, :cond_1

    invoke-virtual {p2, p1}, Lo/sc;->for(I)V
...
.method public getCurrentControllerInfo()Lo/oc;
    .locals 2
    ...
    :try_start_0
    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mRemoteUserInfo:Lo/oc;
...
.method public setCurrentControllerInfo(Lo/oc;)V
    ...
    :try_start_0
    iput-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mRemoteUserInfo:Lo/oc;
...
.method public setPlaybackToLocal(I)V
    ...
    iget-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:Lo/sc;

    if-eqz v0, :cond_0

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Lo/sc;->try(Lo/sc$do;)V
...
.method public setPlaybackToRemote(Lo/sc;)V
    .locals 2
    ...
    iput-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:Lo/sc;

    new-instance p1, Landroid/support/v4/media/session/ParcelableVolumeInfo;

    iget-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:Lo/sc;
...
.method public setVolumeTo(II)V
    ...
    invoke-virtual {p2, p1}, Lo/sc;->new(I)V
