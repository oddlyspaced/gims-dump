...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/work/impl/background/systemalarm/ConstraintProxy;->do:Ljava/lang/String;
...
.method public static do(Landroid/content/Context;Ljava/util/List;)V
    ...
    iget-object v5, v5, Lo/lk;->do:Lo/ih;

    invoke-virtual {v5}, Lo/ih;->case()Z

    move-result v6

    or-int/2addr v1, v6

    invoke-virtual {v5}, Lo/ih;->else()Z

    move-result v6

    or-int/2addr v2, v6

    invoke-virtual {v5}, Lo/ih;->this()Z

    move-result v6

    or-int/2addr v3, v6

    invoke-virtual {v5}, Lo/ih;->if()Lo/sh;

    move-result-object v5

    sget-object v6, Lo/sh;->do:Lo/sh;
    ...
    :cond_2
    invoke-static {p0, v1, v2, v3, v4}, Landroidx/work/impl/background/systemalarm/ConstraintProxyUpdateReceiver;->do(Landroid/content/Context;ZZZZ)Landroid/content/Intent;
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    sget-object v1, Landroidx/work/impl/background/systemalarm/ConstraintProxy;->do:Ljava/lang/String;
