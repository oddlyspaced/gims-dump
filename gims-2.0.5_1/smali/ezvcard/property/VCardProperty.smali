...
.method public final validate(Lezvcard/VCardVersion;Lezvcard/VCard;)Ljava/util/List;
    ...
    invoke-static {v2, v4}, Lo/gy;->do(Lcom/github/mangstadt/vinnie/SyntaxStyle;Z)Lo/fy;

    move-result-object v5

    iget-object v6, p0, Lezvcard/property/VCardProperty;->group:Ljava/lang/String;

    invoke-virtual {v5, v6}, Lo/fy;->for(Ljava/lang/String;)Z

    move-result v6

    if-nez v6, :cond_2

    sget-object v6, Lcom/github/mangstadt/vinnie/SyntaxStyle;->do:Lcom/github/mangstadt/vinnie/SyntaxStyle;

    if-ne v2, v6, :cond_1

    invoke-virtual {v5}, Lo/fy;->new()Lo/fy;
    ...
    invoke-virtual {v2, v4}, Lo/fy;->try(Z)Ljava/lang/String;
